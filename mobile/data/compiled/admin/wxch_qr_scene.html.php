<!-- $Id: wxch_qr_scene.html  17126 2013-12-23 10:30:26Z djks $ -->
...
<div id="tabbar-div">
    <p>
        <span class="tab-front" id="one-table">临时二维码</span>
    </p>
</div>
<div id="tabbody-div">
...
<table width="90%" id="one-table" align="center">
            ...
            <tr>
                ...
                <td>
                    <input name="expire_seconds" type="text"  />
                    <span class="require-field">*</span> 最大为1800秒
                </td>
            </tr>
            <tr>
